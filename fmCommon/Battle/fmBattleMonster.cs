...
{
    public class fmBattleMonster : fmBattleUnit
    {
        protected eRareLv m_rareLv = 0;

        public fmBattleMonster(eRareLv rareLv, fmAbility ab) : base(ab)
        {
            m_ab = ab;
            m_rareLv = rareLv;
        }

        public bool TryGetAbility(out fmAbility ab)
        {
            ab = m_ab;
            if (null == ab)
                return false;
        ...
        public override eRareLv GetRareLv() { return m_rareLv; }
