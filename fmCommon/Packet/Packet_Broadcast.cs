...
namespace fmCommon
{
    public class PT_GC_Broadcast_Public_NT : fmPacket
    {
    ...
    public class PT_OC_Broadcast_Public_NT : fmPacket
    {
        public string m_strContents = string.Empty;

        public PT_OC_Broadcast_Public_NT()
        {
            m_packetType = PacketType.PT_OC_Broadcast_Public_NT;
        }
    ...
    public class PT_OC_Broadcast_Private_NT : fmPacket
    {
        public List<fmOpInfo> ModiInfos = null;

        public PT_OC_Broadcast_Private_NT()
        {
            m_packetType = PacketType.PT_OC_Broadcast_Private_NT;
        }
    ...
    public class PT_OA_Broadcast_SetNotice_RQ : fmPacket
    {
        ...
        {
            m_packetType = PacketType.PT_OA_Broadcast_SetNotice_RQ;
        }
    ...
    public class PT_OA_Broadcast_SetNotice_RS : fmPacket
    {
        public eErrorCode m_eErrorCode = eErrorCode.Error;

        public PT_OA_Broadcast_SetNotice_RS()
        {
            m_packetType = PacketType.PT_OA_Broadcast_SetNotice_RS;
        }
    ...
    public class PT_CA_Broadcast_GetNotice_RQ : fmPacket
    {
        public eLanguage m_eLanguage = eLanguage.English;

        public PT_CA_Broadcast_GetNotice_RQ()
        {
            m_packetType = PacketType.PT_CA_Broadcast_GetNotice_RQ;
        }
    ...
    public class PT_CA_Broadcast_GetNotice_RS : fmPacket
    {
        public eErrorCode m_eErrorCode = eErrorCode.Error;
        public string m_strContents = string.Empty;
        ...
        {
            m_packetType = PacketType.PT_CA_Broadcast_GetNotice_RS;
        }
