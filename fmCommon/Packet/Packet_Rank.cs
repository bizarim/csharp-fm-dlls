...
namespace fmCommon
{
    public class PT_CG_Rank_GetList_RQ : fmPacket
    {

        public PT_CG_Rank_GetList_RQ()
        {
            m_packetType = PacketType.PT_CG_Rank_GetList_RQ;
        }
    ...
    public class PT_CG_Rank_GetList_RS : fmPacket
    {
        ...
        {
            m_packetType = PacketType.PT_CG_Rank_GetList_RS;
        }
    ...
    //public class PT_CG_Rank_Nation_RQ : fmPacket
    //{
    //    public int m_nPage = 0;

    //    public PT_CG_Rank_Nation_RQ()
    //    {
    //        m_packetType = PacketType.PT_CG_Rank_Nation_RQ;
    //    }
    ...
    //public class PT_CG_Rank_Nation_RS : fmPacket
    //{
    //    public eErrorCode m_eErrorCode = eErrorCode.Error;
    ...
    //    {
    //        m_packetType = PacketType.PT_CG_Rank_Nation_RS;
    //    }
