...
namespace fmCommon
{
    public class PT_CG_Lord_SetStat_RQ : fmPacket
    {
        public int m_nAtkPoint = 0;
        public int m_nDefPoint = 0;
        public int m_nHpPoint = 0;

        public PT_CG_Lord_SetStat_RQ()
        {
            m_packetType = PacketType.PT_CG_Lord_SetStat_RQ;
        }

        public override void Serialize(Packet p)
        {
            base.Serialize(p);
            p.WriteInt(m_nAtkPoint);
            p.WriteInt(m_nDefPoint);
            p.WriteInt(m_nHpPoint);
        }

        public override void Deserialize(Packet p)
        {
            base.Deserialize(p);
            m_nAtkPoint = p.ReadInt();
            m_nDefPoint = p.ReadInt();
            m_nHpPoint = p.ReadInt();
        }
    ...
    public class PT_CG_Lord_SetStat_RS : fmPacket
    {
        public rdStat m_rdStat = null;

        public eErrorCode m_eErrorCode = eErrorCode.Error;

        public PT_CG_Lord_SetStat_RS()
        {
            m_packetType = PacketType.PT_CG_Lord_SetStat_RS;
        }
    ...
    public class PT_CG_Lord_EnterWorld_RQ : fmPacket
    {
        public string m_strToken = string.Empty;

        public PT_CG_Lord_EnterWorld_RQ()
        {
            m_packetType = PacketType.PT_CG_Lord_EnterWorld_RQ;
        }
    ...
    public class PT_CG_Lord_CreateLord_RQ : fmPacket
    {
        public string m_strToken = string.Empty;
        ...
        {
            m_packetType = PacketType.PT_CG_Lord_CreateLord_RQ;
        }
    ...
    public class PT_CG_Lord_GetLord_RQ : fmPacket
    {
        public string Name { get; set; }

        public PT_CG_Lord_GetLord_RQ()
        {
            m_packetType = PacketType.PT_CG_Lord_GetLord_RQ;
        }
    ...
    public class PT_CG_Lord_GetLord_RS : fmPacket
    {
        public eErrorCode m_eErrorCode = eErrorCode.Error;
        ...
        {
            m_packetType = PacketType.PT_CG_Lord_GetLord_RS;
        }
    ...
    public class PT_LordInfo : fmPacket
    {
